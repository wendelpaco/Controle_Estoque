...
namespace DAL
{
    public class DALProduto
    {
        ...
        public void Incluir(ModeloProduto obj)
        {
            ...
            cmd.CommandText = "insert into Produto (pro_nome, pro_descricao, pro_foto,  pro_valorpago, pro_valorvenda, pro_qtde,umed_cod , cat_cod, scat_cod, cod_usuario) "+
            "values (@nome,@descricao,@foto,@valorpago,@valorvenda,@qtde,@undmedcod,@catcod,@scatcod, @codUsuario); select @@IDENTITY;";
            ...
            cmd.Parameters.AddWithValue("@codUsuario", Autenticacao.getCodUsuario());
            conexao.Conectar();
