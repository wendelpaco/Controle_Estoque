...
namespace GUI
{
    public partial class frmCadastroProduto : GUI.frmModeloDeFormularioDeCadastro
    {
        ...
        private void btLoFoto_Click(object sender, EventArgs e)
        {
            ...
            od.Title = "Pesquisa de Imagens";
            od.Filter = " Imagens.JPG (*.jpg)|*.jpg| Imagens.PNG (*.png)|*.png| Imagens.ICO (*.ico)|*.ico";
            od.ShowDialog();
            if (!string.IsNullOrEmpty(od.FileName))
            {
                ...
                {
                    MessageBox.Show("Selecione uma imagem no formato: jpg, pn0");
                }
            }
